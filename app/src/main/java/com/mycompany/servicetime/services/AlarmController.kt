...
import com.mycompany.servicetime.receivers.AlarmReceiver
import com.mycompany.servicetime.utilities.getCalendarByHHmm
    ...
    fun setNextAlarm(context: Context, nextTimePoint: Pair<Boolean, Int>) {
        ...
        val alarmIntent = Intent(context, AlarmReceiver::class.java).let { intent ->
            ...
            intent.component = ComponentName(
                ...
                "com.mycompany.servicetime.receivers.AlarmReceiver"
            )
